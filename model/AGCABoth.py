...
from model.AGCAInside import AGCAU_Net7, AGCAU_Net6, AGCAU_Net5, AGCAU_Net4, AttU_Net4F
from model.u2net import _upsample_like

'''
内外都使用了AG和CA，但是内部的CA是一个stage里面共用的，外部的CA是分开的
'''


class AGCABoth(nn.Module):
    def __init__(self, in_ch=3, out_ch=1):
        super(AGCABoth, self).__init__()
